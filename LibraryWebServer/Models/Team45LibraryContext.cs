...
{
    public partial class Team45LibraryContext : DbContext
    {
        public Team45LibraryContext()
        {
        }

        public Team45LibraryContext(DbContextOptions<Team45LibraryContext> options)
            : base(options)
        {
        }
